...
<div class="container">
  ...
  <div class="card">
    ...
    <button class="btn btn-success" onclick="encryptText()" style="width:100%; margin-top:12px">
  ...
  <div class="card">
    ...
    <button class="btn btn-primary" onclick="decryptText()" style="width:100%; margin-top:12px">
      Decrypt Message
    </button>
  </div>
