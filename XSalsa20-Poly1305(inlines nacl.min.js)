...
<head>
  ...
  <meta http-equiv="Content-Security-Policy"
      content="default-src 'none'; style-src 'unsafe-inline'; script-src 'self' 'unsafe-inline'; img-src 'self' data:; base-uri 'none'; form-action 'none'; connect-src 'none';">
...
<body>
  ...
  <div class="cols">
    <div class="row">
      <span class="label">Password (high-entropy, ≥ 32 chars recommended)</span>
